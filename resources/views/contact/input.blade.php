    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="mt-3">
                    {!! Form::open(['action' => 'ContactController@confirm', 'method' => 'patch']) !!}
                        ...
                        <div class="form-group mt-2">
                            ...
                            {!! Form::email('email', null, ['class' => 'form-control', 'id' => 'inputEmail']) !!}
                        </div>
                        
                        <div class="form-group mt-2">
                            {!! Form::label('note', 'お問合せ内容') !!}
                            {!! Form::textarea('note', null, ['class' => 'form-control', 'id' => 'Textarea']) !!}
                        </div>
                        
                        <div class="form-group text-center">
                            {!! Form::submit('確認する', ['class' => 'btn btn-primary w-25']) !!}
                        </div>
